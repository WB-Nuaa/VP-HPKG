...
def train_model(train_data_node, train_data_edge, BB_info, features, labels, args):
    ...
    T_train = T_index[0: int(len(T_index)* args.split)]
    F_train = F_index[0: int(len(F_index)* args.split)]
...
if __name__ == '__main__':
    ...
    train_model(train_data_node, train_data_edge, BB_info, features, labels, args)#Conduct model training
